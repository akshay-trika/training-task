    ...
    <div>
      <div className="footer b-action-primary c-muted-1 pl5 pr5">
        <div className="row  col-12 contain pa9-l pa0-s block">
          {footerSectionItems &&
            footerSectionItems.map((ele, index: number) => (
              <div className="pt3">
                <div className="flex justify-between">
                  <b key={index} className="">
                    {ele.title}
                  </b>
                  {showList == index ? (
                    <button
                      type="button"
                      className="b--black-0125 bg-transparent"
                      onClick={() => handleClose()}
                    >
                ...
                {showList == index && (
                  <ul className="pl0 ma0 " style={{ listStyle: "none" }}>
      ...
      <div className="row  col-12 contain w-100 ph5">
        <div className="flex flex-column">
          <p className="b ">
            Sign up to receive the project antelope newsletter
          </p>
          <input
            type="email"
